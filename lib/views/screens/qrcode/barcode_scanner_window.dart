...
import 'package:vibraguard/views/screens/qrcode/scanner_error_widget.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Mytheme.isDark
            ? R.colors.darkPrimaryBackgroundColor
            : R.colors.lightPrimaryBackgroundColor,
        centerTitle: false,
        title: const Text("Scan New Asset"),
      ),
                      ...
                      children: [
                        ValueListenableBuilder<TorchState>(
                          ...
                          builder: (context, value, child) {
                            ...
                            switch (value) {
                              case TorchState.off:
                                iconColor = R.colors.darkIconColor;
                                break;
                              case TorchState.on:
